...
namespace WolfRPG.Character
{
	...
	{
		Gender, Hair, BackAttachment, Head, Eyebrows, FacialHair, Torso, ArmUpperRight, ArmUpperLeft, ArmLowerRight, ArmLowerLeft, HandRight, HandLeft, Hips, LegRight, LegLeft
	}
